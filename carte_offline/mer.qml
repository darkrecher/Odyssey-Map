...
<qgis version="2.6.1-Brighton" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="carte_req">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="carte_tot">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="xp_min">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="xp_max">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
    ...
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" type="line" name="@0@0">
            <layer pass="0" class="SimpleLine" locked="0">
              ...
              <prop k="line_color" v="222,135,13,255"/>
        ...
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="width_border_expression" v="CASE WHEN $scale &lt; 600000 THEN 0.4 ELSE 0.2 END"/>
        </layer>
      </symbol>
    </symbols>
    <rotation/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="a"/>
    <property key="labeling/fontBold" value="false"/>
    <property key="labeling/fontCapitals" value="0"/>
    <property key="labeling/fontFamily" value="Ebrima"/>
    <property key="labeling/fontItalic" value="false"/>
    <property key="labeling/fontLetterSpacing" value="0"/>
    <property key="labeling/fontLimitPixelSize" value="false"/>
    <property key="labeling/fontMaxPixelSize" value="10000"/>
    <property key="labeling/fontMinPixelSize" value="3"/>
    <property key="labeling/fontSize" value="14.25"/>
    ...
    <property key="labeling/scaleMax" value="400"/>
    <property key="labeling/scaleMin" value="70"/>
    ...
    <property key="labeling/shapeSizeY" value="0.07"/>
  ...
  <displayfield>identifier</displayfield>
  <label>0</label>
  <labelattributes>
